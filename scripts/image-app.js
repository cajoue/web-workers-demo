(function(){
  ...
  function manipulateImage(type) {
    ...
    // the worker is expecting imageData and type of manipulation
    // send it an object with this info
    imageWorker.postMessage({'imageData': imageData, 'type': type});

    // The following loop is already in worker.js
    ...
    // on receipt of the processed work 'e', image is e.data
    ...
    // good practice to include error handler
